...
internal suspend fun loadKotori(): Kotori {
...
suspend fun loadTermDictionary(charset: Charset): TermDictionary<MeCabTermFeatures> {
    ...
    return PlainTermDictionary(entries.toTypedArray())
}
