...
//class PlaylistData private constructor(id: String, context: PlatformContext): Playlist(id, context) {
...
//    }
//
//    fun editPlaylistData(action: AccountPlaylistItemData.() -> Unit): PlaylistData {
//        checkNotDeleted()
//        editData {
...
//
//    companion object {
//        private val playlists: MutableMap<String, PlaylistData> = mutableMapOf()
//
//        fun formatId(id: String): String = id.removePrefix("VL")
//
//        @Synchronized
//        fun fromId(id: String, context: PlatformContext = SpMp.context): PlaylistData {
//            return playlists.getOrPut(id) {
//                val playlist = PlaylistData(id, context)
