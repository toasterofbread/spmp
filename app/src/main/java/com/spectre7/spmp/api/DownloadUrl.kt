...
private const val DEFAULT_CLIENT = """{"clientName":"ANDROID","clientVersion":"16.50","visitorData":null,"hl":"en"}"""
private const val NO_CONTENT_WARNING_CLIENT = """{"clientName":"TVHTML5_SIMPLY_EMBEDDED_PLAYER","clientVersion":"2.0","visitorData":null,"hl":"en"}"""
...
//            return Result.success(format.callAttr("get", "url").toString())
//        }
//    }

    return Result.failure(RuntimeException("Could not find download url for video ID $id"))
}