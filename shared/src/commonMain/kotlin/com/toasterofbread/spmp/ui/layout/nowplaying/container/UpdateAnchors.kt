...
internal fun UpdateAnchors(
    ...
    val swipe_sensitivity: Float by state.settings.state.EXPAND_SWIPE_SENSITIVITY.observe()
...
//    this / processSwipeSensitivity(context.settings.state.EXPAND_SWIPE_SENSITIVITY.get())
