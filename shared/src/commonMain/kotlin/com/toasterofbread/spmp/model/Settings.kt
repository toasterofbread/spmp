...
enum class Settings {
    ...
    KEY_LYRICS_SYNC_DELAY_TOPBAR,
    KEY_LYRICS_SYNC_DELAY_BLUETOOTH,
...
//    KEY_ACC_SCREEN_OFF,
    ...
    KEY_FEED_GRID_ROW_COUNT,
    KEY_FEED_GRID_ROW_COUNT_EXPANDED,
    KEY_FEED_ALT_GRID_ROW_COUNT,
    KEY_FEED_ALT_GRID_ROW_COUNT_EXPANDED,
    ...
    KEY_NP_QUEUE_ITEM_SWIPE_SENSITIVITY,
    KEY_NP_QUEUE_EXTRA_SIDE_PADDING,
    ...
    companion object {
        ...
        fun <T> getDefault(enum_key: Settings): T {
            return when (enum_key) {
                ...
                KEY_LYRICS_SYNC_DELAY_TOPBAR -> -0.5f
                KEY_LYRICS_SYNC_DELAY_BLUETOOTH -> 0.3f
...
//                KEY_ACC_SCREEN_OFF -> false
                ...
                KEY_NP_QUEUE_ITEM_SWIPE_SENSITIVITY -> 1f
                KEY_NP_QUEUE_EXTRA_SIDE_PADDING -> 0f
